...
void net_initialize(void) {
  ...
  //MDF_ERROR_ASSERT(storage_get_wifi_ssid(ssid, VARLEN));
  //MDF_ERROR_ASSERT(storage_get_wifi_password(wifipwd, VARLEN));
  //MDF_ERROR_ASSERT(storage_get_mesh_id(meshid, VARLEN));
  //MDF_ERROR_ASSERT(storage_get_mesh_password(meshpwd, VARLEN));
   ...
   *
   ...
   uint8_t mesh_id[6] -   Information about the mesh internal connected.
   ...
   */
    ...
    //memcpy((void*)config.router_ssid, (void*)ssid,strlen(ssid)+ 1);
    //memcpy((void*)config.router_password, (void*)wifipwd,strlen(wifipwd)+ 1);


    //memcpy((void*)config.mesh_id, (void*)meshid,strlen(meshid)+ 1);
    //memcpy((void*)config.mesh_password, (void*)meshpwd,strlen(meshpwd)+ 1);
    ...
    /* = { */
    /*     .router_ssid     = ssid, */
    /*     .router_password = wifipwd, */
    /*     .mesh_id         = meshid, */
    /*     .mesh_password   = meshpwd */
    /* }; */
